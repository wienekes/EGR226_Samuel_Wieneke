...
int main(void)
{
    ...
    char firstName[6]={'S', 'A', 'M', 'U', 'E', 'L'};
    char lastName[7]={'W', 'I', 'E', 'N', 'E', 'K', 'E'};
    char line3[3]={'E', 'G', 'R'};
    char line4[3]={'2', '2', '6'};
    int i;

    commandWrite(1); // Clear display
    commandWrite(0x84); // Setting cursor to 5th spot on line 1
    ...
    commandWrite(0xC4); // Setting cursor to 5th spot on line 2
